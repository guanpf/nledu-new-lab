...
export default class FlipDown {
  ...
  **/
  _tick() {
    ...
    diff -= this.clockValues.studymap * 86400;
  ...
  **/
  _updateClockValues(init = false) {
    ...
    this.clockStrings.d = pad(this.clockValues.studymap, 2);
    this.clockStrings.h = pad(this.clockValues.h, 2);
    this.clockStrings.m = pad(this.clockValues.m, 2);
    this.clockStrings.s = pad(this.clockValues.s, 2);

    // Concat clock value strings
    this.clockValuesAsString = (this.clockStrings.studymap + this.clockStrings.h + this.clockStrings.m + this.clockStrings.s).split('');
