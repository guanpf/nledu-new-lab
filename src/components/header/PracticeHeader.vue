  <template>
    <div class="container">
      <div class="logo-wrap">
        <img src="/logos/logo-exam-practice.svg" alt="logo" class="logo-img" />
      </div>

      <div class="right">

        <!--<div is-dot class="item cursor-pointer">
  ...
  <script>
    ...
    export default {
      ...
      computed: {
        ...mapState("practiceUser", ["name", "avatar", "role", "token"])
      },
      methods: {
        ...mapActions("practiceUser", ["getInfo", "logout"]),
        logoutHandler() {
          // localStorage.clear();
          this.logout()
          ...
          setTimeout(()=> {
            this.$router.push({ name: "practice-index" });
          }, 300)
        },
      },
      mounted() {
