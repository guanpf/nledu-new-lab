...
<!--            label-width="60px"-->
            ...
            <nl-form-item
                    ...
                    :show-message="true"
            >
                <div  style="color:#fff;line-height:20px;margin-top: 20px;">验证码</div>
                <nl-input
                ...
                >
                    ...
                    <!--&gt;-->
                    <!--<img src="http://192.168.1.82:8080/nledu-eaframe-auth/imagecode" alt="" style="">-->
                    <!--</template-->
                    <!--&gt;-->
                </nl-input>
                <img
                        :src="`/api/nledu-eaframe-auth/imagecode?timestamp=${now}&sid=${sid}`"
                        alt=""
           ...
           <div class="login-btn" @click="loginHandler">立即登录</div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            console.log(109,`/api/nledu-eaframe-auth/imagecode?timestamp=${this.now}&sid=${this.sid}`)
            // todo set cookies
